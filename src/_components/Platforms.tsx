import { type PlatformList } from "@/types";
...
function Platform(props: IconsProps) {
  ...
  return <Icon className={`${className} h-3 w-3`} title={title} />;
}
